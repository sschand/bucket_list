...
myApp.controller('ProfileController', function($scope, UserFactory, BucketFactory, $location) {
    ...
    BucketFactory.get_profile_for(function(data){
        $scope.get_profile_user = data;
    });
    // Logout
    ...
    //Get list
    UserFactory.getList($scope.get_profile_user, function(data){
        $scope.list = data.user.bucketList;
